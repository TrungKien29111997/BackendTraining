...
\restrict eZi3PZMKsI6z6R0xmnNgDIkyiW3oSxcOYSCVZ3xghxLm3lrPiqTBcZ8YcUeJO7I
...
--
-- Name: courses_courses_id_seq; Type: SEQUENCE; Schema: public; Owner: root
--
...
ALTER SEQUENCE public.courses_courses_id_seq OWNER TO root;

--
-- Name: courses_courses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: root
--

ALTER SEQUENCE public.courses_courses_id_seq OWNED BY public.courses.courses_id;
...
--
-- Name: courses courses_id; Type: DEFAULT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.courses ALTER COLUMN courses_id SET DEFAULT nextval('public.courses_courses_id_seq'::regclass);
...
COPY public.courses (courses_id, name) FROM stdin;
\.
...
COPY public.students_courses (student_id, courses_id) FROM stdin;
\.
...
--
-- Name: courses_courses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--

SELECT pg_catalog.setval('public.courses_courses_id_seq', 1, false);
...
ALTER TABLE ONLY public.students_courses
    ADD CONSTRAINT students_courses_pkey PRIMARY KEY (student_id, courses_id);
...
--
-- Name: students_courses fk_courses; Type: FK CONSTRAINT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.students_courses
    ADD CONSTRAINT fk_courses FOREIGN KEY (courses_id) REFERENCES public.courses(courses_id) ON DELETE CASCADE;
...
\unrestrict eZi3PZMKsI6z6R0xmnNgDIkyiW3oSxcOYSCVZ3xghxLm3lrPiqTBcZ8YcUeJO7I
